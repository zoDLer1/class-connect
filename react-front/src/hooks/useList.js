...
export const useList = (onAutoClose = () => null) => {
    ...
    return [list, { setItems, addItem, updateItem, selectedStateOn, removeItem, setItemProp, getItem }, { editModeOn, editModeOff, loadingState }, { storeProp, reject, commit }, selectedItem]
}
